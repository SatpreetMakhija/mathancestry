  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <button
          onClick={openPalette}
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-border rounded-xl text-muted hover:text-ink hover:border-accent/30 transition-colors shadow-sm cursor-pointer"
        ...
        >
          ...
          <kbd className="hidden sm:inline-block ml-2 px-1.5 py-0.5 text-[10px] bg-parchment rounded border border-border">
            ⌘K
          </kbd>
        </button>
      </div>
